    ...
    <div className="relative min-h-screen w-full bg-neutral-950 text-slate-200 overflow-hidden px-6 py-12">
      ...
      <div className="max-w-3xl mx-auto text-lg leading-relaxed text-center">
        <p className="mb-4">
          ...
          <PointerHighlight className="flex justify-center">
            <span className="block">System Associate Developer at Vizserve Private Limited</span>
          </PointerHighlight>, where I specialize in building modern, responsive web applications.
        </p>
        <p className="mb-4">
