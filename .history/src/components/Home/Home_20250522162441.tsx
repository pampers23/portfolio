    ...
    <div className="relative min-h-screen w-full bg-neutral-950 text-slate-200 overflow-hidden">
      ...
      <div className="relative z-10 flex w-full max-w-5xl items-center justify-between px-8 py-20 mx-auto" style={{ minHeight: 'calc(100vh - 80px)' }}>
        <div className="flex-1 flex flex-col items-start justify-center">
          <h1 className="text-5xl font-extrabold text-slate-100">I'm <ContainerTextFlip words={["Lance", "Frontend Developer", "System Developer"]}/></h1>
        </div>
        <div>
          <p className="mt-4 text-lg text-slate-300">A Web Developer based in the Philippines</p>
          <p className="mt-2 text-lg text-slate-300">Passionate of creating modern and responsive web applications.</p>
        </div>
