...
const About = () => {
  ...
  const isDesktopInView = useInView(profileRef, {
    once: true,
    margin: "-100px",
  });
  ...
  return (
    <div className="min-h-screen lg:grid lg:grid-cols-[minmax(0,420px)_1fr] gap-8 lg:gap-20 px-6 lg:px-12 py-24">
      ...
      {/* ✅ Desktop Profile (Sticky Sidebar) */}
      <motion.div
        ref={profileRef}
      ...
      <motion.div
        ...
        className="lg:hidden mb-16 max-w-md mx-auto pl-15 sm:pl-30"
      >
        <ProfileCard
          name="Lance Brixter Mendoza"
          title="Web Developer"
          ...
          avatarUrl={AvatarImg}
          showUserInfo={false}
          enableTilt={false} // ✅ IMPORTANT for mobile
          enableMobileTilt={false}
          onContactClick={() => console.log("Contact clicked")}
          behindGlowColor="rgba(125, 190, 255, 0.67)"
          behindGlowEnabled
